...
public class TancSoStudentite {
    ...
    Semaphore presoblekuvanjeMaski, presoblekuvanjeZenski;
    Semaphore spremniZenski, tancParovi;
    public void init() {
        //TODO: da se implementira
        presoblekuvanjeMaski = new Semaphore(10);
        presoblekuvanjeZenski = new Semaphore(10);
        spremniZenski = new Semaphore(0);
        tancParovi = new Semaphore(3);
    }
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
            presoblekuvanjeMaski.acquire();
            show.presobleci();
            presoblekuvanjeMaski.release();
            // samo maskoto go povikuva metodot tancuvaj
            tancParovi.acquire();
            spremniZenski.acquire();
            show.tancuvaj();
            tancParovi.release();
        }
    ...
    class Zensko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
            presoblekuvanjeZenski.acquire();
            show.presobleci();
            spremniZenski.release();
            presoblekuvanjeZenski.release();
        }
